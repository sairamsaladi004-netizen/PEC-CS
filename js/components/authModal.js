        ...
        <div class="p-6">
          ...
          <div id="tab-content-login" class="auth-tab-content hidden space-y-4">
            <div>
              ...
              <p class="text-xs text-slate-500 mt-0.5">Login with your Panimalar Roll Number or official college email</p>
            </div>
            ...
            <form id="college-login-form" class="space-y-3 text-xs">
              <div>
                ...
                <input type="text" id="login-identifier" required placeholder="e.g. 22CS101 or aarav.sharma@panimalar.edu" class="w-full p-2.5 rounded-xl border border-slate-200 focus:ring-2 focus:ring-blue-500 font-mono" />
              </div>
              <div>
          ...
          <div id="tab-content-register" class="auth-tab-content hidden space-y-4">
            ...
            <form id="student-register-form" class="space-y-3 text-xs">
              ...
              <div>
                ...
                <input type="email" id="reg-email" required placeholder="student@panimalar.edu" class="w-full p-2.5 rounded-xl border border-slate-200 focus:ring-2 focus:ring-blue-500 font-mono" />
              </div>
