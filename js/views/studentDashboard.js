    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div class="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
          <div class="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Total Engagement Hours</div>
          <div class="text-2xl font-black text-slate-900 mt-1">42.5</div>
        </div>
        <div class="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
          <div class="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Events Attended</div>
          <div class="text-2xl font-black text-blue-600 mt-1">12</div>
        </div>
        <div class="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
          <div class="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Certificates Earned</div>
          <div class="text-2xl font-black text-emerald-600 mt-1">4</div>
        </div>
      </div>

      <!-- Attendance Trend Chart -->
      <div id="attendance-chart-wrapper">
      </div>
...
export function attachStudentDashboardEvents() {
  ...
  if (chartWrapper) {
    chartWrapper.innerHTML = renderAttendanceTrendChartCard();
