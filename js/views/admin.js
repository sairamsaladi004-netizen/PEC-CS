    ...
    <div class="max-w-2xl mx-auto bg-white rounded-3xl border border-slate-200 p-6 sm:p-8 shadow-sm space-y-6">
      ...
      <div class="space-y-4 text-xs">
        ...
        <div>
          ...
          <input type="text" value="smtp://mail.panimalar.edu:587/campus-announcements" class="w-full p-2.5 rounded-xl border border-slate-200 focus:ring-2 focus:ring-blue-500 font-mono" />
        </div>
