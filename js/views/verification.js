            ...
            <div class="bg-white rounded-3xl border-2 border-emerald-500 p-6 sm:p-8 shadow-xl space-y-6">
              ...
              <div class="flex items-center space-x-3 p-4 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-900">
                ...
                <div>
                  ...
                  <div class="text-xs text-emerald-700">Verified by Pragati University / Pragati Engineering College (Autonomous) CCTSC Digital Registry</div>
                  <div class="text-[10px] text-emerald-600 font-mono">Accredited by NAAC & NBA • Surampalem, Near Kakinada, AP</div>
                </div>
              </div>
