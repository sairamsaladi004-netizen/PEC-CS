...
export function renderStudyCirclesView() {
  ...
  return `
    <div class="max-w-7xl mx-auto space-y-8 pb-12">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-6 relative z-10">
          <div class="space-y-2 max-w-2xl">
            <div class="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-indigo-500/20 text-indigo-300 text-xs font-bold border border-indigo-400/30">
              <span>👥 Real-Time Collaborative Network</span>
            </div>
            <h1 class="text-2xl sm:text-3xl font-black tracking-tight text-white">Peer Circles & Technical Study Groups</h1>
            <p class="text-xs sm:text-sm text-slate-300 leading-relaxed">
              Join peer-led study circles at Pragati Engineering College. Collaborate on open-source projects, discuss problem sets, share code snippets, and interact in real time with faculty mentors and peer leaders.
            </p>
          </div>
      ...
      <!-- Real-Time Peer Circle Chat Component -->
      <div class="space-y-3">
        <div class="flex items-center justify-between">
          <h2 class="text-lg font-black text-slate-900 flex items-center space-x-2">
            <span>💬 Live Peer Circle Collaboration Hub</span>
            <span class="px-2 py-0.5 bg-indigo-100 text-indigo-800 text-[10px] font-bold rounded-full uppercase tracking-wider">Supabase Powered</span>
          </h2>
          <span class="text-xs text-slate-500 font-medium">Real-time messaging, code sharing & peer presence</span>
        </div>
      ...
      <div class="space-y-4">
        <h2 class="text-lg font-black text-slate-900">Active Campus Study Guilds</h2>
