    ...
    return `
      <div class="space-y-6 pb-16">
        ...
        <div id="printable-certificate" class="printable-area max-w-4xl mx-auto rounded-3xl p-8 sm:p-14 text-slate-900 text-center relative overflow-hidden shadow-2xl ${frameBorder}">
          ...
          <div class="absolute top-4 right-4 ${accentColor} text-xs font-serif select-none">✦ PRAGATI UNIVERSITY ✦</div>
          <div class="absolute bottom-4 left-4 ${accentColor} text-xs font-serif select-none">✦ PRAGATI UNIVERSITY ✦</div>
          <div class="absolute bottom-4 right-4 ${accentColor} text-xs font-serif select-none">✦ PRAGATI UNIVERSITY ✦</div>
          ...
          <div class="mt-12 pt-6 border-t border-slate-200/80 flex flex-col sm:flex-row items-center justify-between gap-6 text-left">
            ...
            <div class="text-center sm:text-left space-y-1">
              <div class="font-serif italic text-sm text-blue-950 font-bold">Mr. K. Siva Shankar</div>
              ...
              <div class="text-[9px] text-slate-500 font-mono">Central Technical Societies Council</div>
            </div>
            ...
            <div class="flex flex-col items-center">
              <div class="w-16 h-16 rounded-full flex items-center justify-center text-amber-900 font-black text-xs border-2 border-amber-500 bg-amber-100 shadow-md">
                <span class="text-center text-[8px] uppercase leading-tight font-extrabold text-amber-950">PRAGATI<br/>UNIVERSITY<br/>AUTONOMOUS</span>
              </div>
              <span class="text-[9px] text-slate-500 font-mono mt-1">OFFICIAL INSTITUTIONAL SEAL</span>
            </div>
            ...
            <div class="flex items-center space-x-3 text-right">
              <div>
                ...
                <div class="text-[9px] text-slate-500 font-mono">Pragati University Ledger</div>
          ...
          <!-- Institutional Authority Signatory -->
          <div class="mt-6 pt-4 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between text-slate-600 text-xs">
            <div class="text-[10px] font-mono text-slate-500">
              Authority: Dr. K. Satyanarayana (Principal, Pragati Engineering College / Pragati University)
            </div>
            <div class="text-[10px] font-mono text-slate-500">
              Registrar Verification: REG-PU-AP-2026
            </div>
          </div>
    ...
    if (bulkForm) {
      bulkForm.addEventListener("submit", (e) => {
        ...
        const attendees = evt?.registrations?.length > 0 ? evt.registrations : [
          { studentName: "Aarav Sharma", rollNo: "22CS101", studentId: "std-1", department: "CSE", email: "aarav.sharma@pragati.ac.in" },
          { studentName: "Kavya Patel", rollNo: "22CS142", studentId: "std-2", department: "AIDS", email: "kavya.patel@pragati.ac.in" },
          { studentName: "Sneha Reddy", rollNo: "23CS205", studentId: "std-3", department: "CSE", email: "sneha.reddy@pragati.ac.in" }
        ];
