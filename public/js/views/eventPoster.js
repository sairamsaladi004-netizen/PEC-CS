        ...
        <div class="lg:col-span-5 bg-white p-6 rounded-3xl border border-slate-200 shadow-sm space-y-4">
          ...
          <div class="space-y-3 text-xs">
            ...
            <div>
              ...
              <input type="text" id="poster-url" value="https://campustech.pragati.ac.in/#/events" class="w-full p-2.5 rounded-xl border border-slate-300 font-mono text-[11px] focus:ring-2 focus:ring-blue-500" />
            </div>
          </div>
        </div>
...
export function attachEventPosterEvents() {
  ...
  const renderPoster = () => {
    ...
    ctx.fillText("PRAGATI ENGINEERING COLLEGE • PRAGATI UNIVERSITY", 300, 55);
